...
def distributions():
    ...
    types = [9, 23, 24]
    # bond type 9 = c5,c5
    # angle type 23 = ca,c5,ca
    # dihedral type 24 = c5,ca,ca,ca
...
def c2():
    base_dir = Path(__file__).resolve().parent
    data_file = base_dir / "equilibrated.lmps"
    dump_file = base_dir / "compress_01.lammpstrj"
    timestep_fs = 1
    max_lag_ps = 2000
    stride = 1
    backbone_selection = "type 4 5" # ca-ca, ca-c5, and c5-c5
    origin_stride_ps = 10
