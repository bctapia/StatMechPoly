...
if __name__ == "__main__":
    type_to_name = get_atom_type_map(Path(__file__).resolve().parent.parent / "12_lmp_skeleton" /"ua_skeleton.data")
    write_all_coeffs(
        data_file=Path(__file__).resolve().parent.parent / "12_lmp_skeleton" /"ua_skeleton.data",
        table_dir=Path(__file__).resolve().parent.parent / "13_lmp_tables",
