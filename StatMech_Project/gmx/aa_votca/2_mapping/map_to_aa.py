...
def build_aa_groups(atoms, types, names, type_map=None):
    groups = []
    ...
    for a in atoms:
        ...
        groups.append({
            ...
            "type": new_type,
            "atoms": [a.idx],
            "weights": [1.0],   # or [a.mass] if you want mass-weighted AA maps
        })
...
def make_mapping(dump, top, out, ident_name, cg_name, type_map=None):
    ...
    groups = build_aa_groups(atoms, types, names, type_map=type_map)
...
if __name__ == "__main__":
    ...
    dump_file = base_dir / "1_map_votca" / "1_csg_dump" / "out_4670701.out"
